#This script is for NST caculation form  https://github.com/DaliangNing/NST/tree/master/Examples/SimpleOTU 
#if you use this script in your research please cite: 
#Ning, D., Deng, Y., Tiedje, J. M., & Zhou, J. (2019). A general framework for quantitatively assessing ecological stochasticity. Proceedings of the National Academy of Sciences, 116(34), 16892-16898.
########################

# version 20210511
# 1 # file and folder path and parameters 

wd="C:/Users/USER/Desktop/NST" # change to folder path in your computer, where the input files are saved
save.wd="C:/Users/USER/Desktop/NST" # folder path, where to save the output files
...
nworker=6 # parallell computing thread number.
